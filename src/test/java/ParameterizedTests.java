...
public class ParameterizedTests {
    ...
    @Tag("MATH")
    public void calcsetSiteCalculatesSquareRootCorrectlyTest(int number){
    ...
    @Tag("SMOKE")
    public void sstuSearchShowsArticlesCorrectTest(String searchQuery, String expectedText) {
    ...
    @Tag("SMOKE")
    void rzdSiteShouldDisplayApplicationsSetTest(Applications apps){
    ...
    static Stream<Arguments> sheremetyevoSiteHaveCorrectMenuItemsOnEngAndRusTest() {
        return Stream.of(
    ...
    @Tag("SMOKE")
    void sheremetyevoSiteHaveCorrectMenuItemsOnEngAndRusTest(Language language, List<String> menuItems) {
